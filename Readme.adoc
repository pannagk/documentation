...
*_Skip the below steps and jump to <<dev_license_request>> if you are already registered on Cloudera SSO._*
...
NOTE: Make sure registration is done using an official email id.
...
== Request For Development License [[dev_license_request]]
